...
<p> 10 과 10은 같아요 : <strong>${10 == 10 }</strong></p>
<p> 10 과 10은 같아요 : <strong>${10 eq 10 }</strong></p>
<p> 10 과 10은 달라요 : <strong>${10 != 10 }</strong></p>
<p> 10 과 10은 달라요 : <strong>${10 ne 10 }</strong></p>
...
<h3>empty 연산자(자주 사용됨, 값이 비었는지 여부를 판단)</h3>
